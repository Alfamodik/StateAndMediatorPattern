...
{
    protected bool WalkingMode;
    protected bool FastRunningMode;
    ...
    public override void HandleInput()
    {
        ...
        WalkingMode = Input.Movement.Walking.inProgress;
        FastRunningMode = Input.Movement.FastRunning.inProgress;
    }
